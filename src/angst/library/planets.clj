...
(def planet-map
  {:Petiska {:name "Petiska" :colour "Black" :x 85 :y 48
   ...
   :Odyssey {:name "Odyssey" :colour "Green" :x 205 :y 290
   			 :connections [:Valeria :Kazo :Shoran :Echemmon :Altu :Uchino :Thalia] :ships 1 :moved 0 :ship-colour "Green"
             :production [0 0 1 3 5 4 3 3] :development 0 :used false}
   ...
   :Caia {:name "Caia" :colour "Blue" :x 500 :y 85
   		  :connections [:Chiu :Xosa :Path :Quinz :Echemmon] :ships 1 :moved 0 :ship-colour "Blue"
           :production [1 1 1 1 1 1 1 1] :development 0 :used false}
   ...
   :Valeria {:name "Valeria" :colour "Green" :x 35 :y 350
   			 :connections [:Kazo :Odyssey :Uchino :Zellner] :ships 1 :moved 0 :ship-colour "Green"
             :production [0 1 2 3 4 5 5 5] :development 3 :used false}
   ...
   :Walden {:name "Walden" :colour "Red" :x 390 :y 710
   			:connections [:Tomaso :Tyson :Ryss :Bhowmik :Glushko] :ships 1 :moved 0 :ship-colour "Red"
            :production [1 2 2 2 2 3 3 3] :development 0 :used false}
   :Ryss {:name "Ryss" :colour "Red" :x 425 :y 575
   		  :connections [:Walden :Tyson :Kanolta :Salman :Bhowmik] :ships 1 :moved 0 :ship-colour "Red"
           :production [4 4 3 3 2 2 2 2] :development 0 :used false}
   ...
   :Erasmus {:name "Erasmus" :colour "Yellow" :x 985 :y 380
   			 :connections [:Froya :VanVogt :Iago :Nussbaum] :ships 1 :moved 0 :ship-colour "Yellow"
             :production [1 3 2 4 3 5 4 2] :development 1 :used false}
   :Iago {:name "Iago" :colour "Yellow" :x 850 :y 340
   		  :connections [:Erasmus :VanVogt :Jaid :Lisst :Nussbaum] :ships 1 :moved 0 :ship-colour "Yellow"
   ...
   :Path {:name "Path" :colour "Blue" :x 640 :y 160
   		  :connections [:Fignon :Xosa :Caia :Quinz :Byrd :Lisst] :ships 1 :moved 0 :ship-colour "Blue"
           :production [0 0 1 2 3 5 6 6] :development 3 :used false}
